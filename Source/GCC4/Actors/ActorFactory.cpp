...
ActorFactory::ActorFactory(void)
{
	...
	m_componentFactory.Register<LaserRenderComponent>(ActorComponent::GetIdFromName(LaserRenderComponent::g_Name));
    m_componentFactory.Register<SpaceshipRenderComponent>(ActorComponent::GetIdFromName(SpaceshipRenderComponent::g_Name));
	m_componentFactory.Register<EnemySpaceshipRenderComponent>(ActorComponent::GetIdFromName(EnemySpaceshipRenderComponent::g_Name));
	m_componentFactory.Register<AsteroidRenderComponent>(ActorComponent::GetIdFromName(AsteroidRenderComponent::g_Name));
