...
//
////////////////////////////////////////////////////
class D3DLaserMeshNode9 : public D3DShaderMeshNode9
{
public:
	D3DLaserMeshNode9(const ActorId actorId, WeakBaseRenderComponentPtr renderComponent, std::string fxFileName, RenderPass renderPass, const Mat4x4 *t);
	virtual HRESULT VOnRestore(Scene *pScene);
};

class D3DSpaceshipMeshNode9 : public D3DShaderMeshNode9
{
public:
	D3DSpaceshipMeshNode9(const ActorId actorId, WeakBaseRenderComponentPtr renderComponent, std::string fxFileName, RenderPass renderPass, const Mat4x4 *t);
	virtual HRESULT VOnRestore(Scene *pScene);
};

class D3DAsteroidMeshNode9 : public D3DShaderMeshNode9
{
public:
	D3DAsteroidMeshNode9(const ActorId actorId, WeakBaseRenderComponentPtr renderComponent, std::string fxFileName, RenderPass renderPass, const Mat4x4 *t);
	virtual HRESULT VOnRestore(Scene *pScene);
};

class D3DEnemySpaceshipMeshNode9 : public D3DShaderMeshNode9
{
public:
	D3DEnemySpaceshipMeshNode9(const ActorId actorId, WeakBaseRenderComponentPtr renderComponent, std::string fxFileName, RenderPass renderPass, const Mat4x4 *t);
	virtual HRESULT VOnRestore(Scene *pScene);
};
...
class D3DLaserMeshNode11 : public D3DShaderMeshNode11
{
public:
	D3DLaserMeshNode11(const ActorId actorId, WeakBaseRenderComponentPtr renderComponent, RenderPass renderPass, const Mat4x4 *t)
		: D3DShaderMeshNode11(actorId, renderComponent, "art\\laser_fire.sdkmesh", renderPass, t) { }
	bool VIsVisible() { return true; }
};

class D3DSpaceshipMeshNode11 : public D3DShaderMeshNode11
{
public:
	D3DSpaceshipMeshNode11(const ActorId actorId, WeakBaseRenderComponentPtr renderComponent, RenderPass renderPass,const Mat4x4 *t)
		: D3DShaderMeshNode11(actorId, renderComponent, "art\\Spaceship.sdkmesh", renderPass, t) { }
	bool VIsVisible() { return true; }
};

class D3DAsteroidMeshNode11: public D3DShaderMeshNode11
{
public:
	D3DAsteroidMeshNode11(const ActorId actorId, WeakBaseRenderComponentPtr renderComponent, RenderPass renderPass, const Mat4x4 *t)
		: D3DShaderMeshNode11(actorId, renderComponent, "art\\Asteroid.sdkmesh", renderPass, t) { }
	bool VIsVisible() { return true; }
};

class D3DEnemySpaceshipMeshNode11 : public D3DShaderMeshNode11
{
public:
	D3DEnemySpaceshipMeshNode11(const ActorId actorId, WeakBaseRenderComponentPtr renderComponent, RenderPass renderPass, const Mat4x4 *t)
		: D3DShaderMeshNode11(actorId, renderComponent, "art\\EnemySpaceship.sdkmesh", renderPass, t) { }
	bool VIsVisible() { return true; }
};
