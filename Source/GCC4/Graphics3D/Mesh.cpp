...
D3DLaserMeshNode9::D3DLaserMeshNode9(const ActorId actorId, WeakBaseRenderComponentPtr renderComponent, std::string fxFileName, RenderPass renderPass, const Mat4x4 *t)
...
//
HRESULT D3DLaserMeshNode9::VOnRestore(Scene *pScene)
{
	HRESULT hr;
...
//
D3DSpaceshipMeshNode9::D3DSpaceshipMeshNode9(const ActorId actorId, WeakBaseRenderComponentPtr renderComponent, std::string fxFileName, RenderPass renderPass, const Mat4x4 *t)
: D3DShaderMeshNode9(actorId, renderComponent, NULL, fxFileName, renderPass, t) 
{ 
	// there's nothing else needed here...
}
...
// TeapotMeshNode::VOnRestore						- Chapter X, page Y
//
HRESULT D3DSpaceshipMeshNode9::VOnRestore(Scene *pScene)
{
	HRESULT hr;
...
// TeapotMeshNode::TeapotMeshNode					- Chapter X, page Y 
//
D3DAsteroidMeshNode9::D3DAsteroidMeshNode9(const ActorId actorId, WeakBaseRenderComponentPtr renderComponent, std::string fxFileName, RenderPass renderPass, const Mat4x4 *t)
	: D3DShaderMeshNode9(actorId, renderComponent, NULL, fxFileName, renderPass, t)
{
	// there's nothing else needed here...
}
...
// TeapotMeshNode::VOnRestore						- Chapter X, page Y
//
HRESULT D3DAsteroidMeshNode9::VOnRestore(Scene *pScene)
{
	HRESULT hr;
...
// TeapotMeshNode::TeapotMeshNode					- Chapter X, page Y 
//
D3DEnemySpaceshipMeshNode9::D3DEnemySpaceshipMeshNode9(const ActorId actorId, WeakBaseRenderComponentPtr renderComponent, std::string fxFileName, RenderPass renderPass, const Mat4x4 *t)
	: D3DShaderMeshNode9(actorId, renderComponent, NULL, fxFileName, renderPass, t)
{
	// there's nothing else needed here...
}
...
// TeapotMeshNode::VOnRestore						- Chapter X, page Y
//
HRESULT D3DEnemySpaceshipMeshNode9::VOnRestore(Scene *pScene)
{
	HRESULT hr;
