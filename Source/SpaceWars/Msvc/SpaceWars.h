...
//---------------------------------------------------------------------------------------------------------------------
// SpaceWarsApp class                          - Chapter 21, page 722
// Note: Don't put anything in this class that needs to be destructed
//---------------------------------------------------------------------------------------------------------------------
class SpaceWarsApp : public GameCodeApp
{
protected:
	virtual BaseGameLogic *VCreateGameAndView();

public:
	virtual TCHAR *VGetGameTitle() { return _T("Space Wars"); }
...
//---------------------------------------------------------------------------------------------------------------------
class SpaceWarsLogic : public BaseGameLogic
{
protected:
